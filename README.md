...
This code underlies [EIG's comment letter](https://eig.org/eig-letter-dhs-should-revise-proposed-h-1b-weighted-lottery-to-prioritize-top-talent/) to the Department of Homeland Security in response to its proposed wage-level-weighted-lottery rule and the accompanying [Agglomerations post](https://agglomerations.substack.com/p/theres-a-better-way-to-allocate-h). Contact research@eig.org with any questions.

******

### Data Sources

- New H-1B petitions, FY2021-2024, U.S. Citizenship & Immigration Services (USCIS) Form I-129 microdata, obtained through a Freedom of Information Act request filed by Bloomberg L.P., available at [*Bloomberg Graphics, 2024 H-1B Immigration Data*](https://github.com/BloombergGraphics/2024-h1b-immigration-data).
- Labor Condition Application disclosure data, FY2015-2024, Office of Foreign Labor Certification (OFLC), available [here](https://www.dol.gov/agencies/eta/foreign-labor/performance).
- Prevailing wage levels by Standard Occupational Classification (SOC) occupation codes and metropolitan statistical areas (MSAs), FY2024, OFLC, available at [Foreign Labor Application Gateway (FLAG) website](https://flag.dol.gov/wage-data/wage-search).
- Zip code to county crosswalk, 2024 Q4, U.S. Department of Housing and Urban Development (HUD), available at [Office of Policy Development and Research (PD&R) website](https://www.huduser.gov/portal/datasets/usps_crosswalk.html).
...
- State-level Regional Price Parity (RPP), 2021-2023, U.S. Bureau of Economic Analysis, accessed [here](https://www.bea.gov/data/prices-inflation/regional-price-parities-state-and-metro-area).
...
We link H-1B lottery winners from FY 2021 to FY 2024 with LCA disclosure data from FY 2015 to FY 2024 using DOL case IDs, accounting for the multi-year processing time of LCAs. Entries censored under sections (b)(3), (b)(6), or (b)(7)(C) of the Freedom of Information Act (FOIA) are excluded. Entries listing applicants under 18 years of age are presumed to be erroneous, as the H-1B program requires at least a bachelor’s degree, and are therefore excluded from the analysis.
